...
// TanStack Start / Vite static output (after `bun run build`)
const directoryName = '.output/public'
...
if (!BUCKETNAME) {
  console.log('☢️   Enter a bucket name in apps/web/scripts/s3.js ')
  process.exit(1)
}
...
try {
  ...
  console.log(e)
  console.log(
    '☢️   Create an aws.json credentials file in apps/web/ like { "accessKeyId": "xxx", "secretAccessKey": "xxx", "region": "xxx" } ',
  )
  process.exit(1)
}
