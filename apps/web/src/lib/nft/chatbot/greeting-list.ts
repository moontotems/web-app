...
const greetingList = [
  ...
  {
    message: 'One sees great things from the valley; only small things from the peak.',
  },
  {
    message: 'The world will never starve for want of wonders; but only for want of wonder.',
  },
  {
    message: 'The poets have been mysteriously silent on the subject of cheese.',
  },
  {
    message: 'A dead thing can go with the stream, but only a living thing can go against it.',
  },
  {
    message:
  ...
  {
    message: 'The traveler sees what he sees. The tourist sees what he has come to see.',
  },
  {
    message: 'Do not be so open-minded that your brains fall out.',
  },
  {
    message: 'To have a right to do a thing is not at all the same as to be right in doing it.',
  },
  {
  ...
  {
    message: 'Fallacies do not cease to be fallacies because they become fashions.',
  },
  {
  ...
  {
    message: 'How you think when you lose determines how long it will be until you win.',
  },
  {
    message: 'There are no rules of architecture for a castle in the clouds.',
  },
  {
    message: 'The man who kills a man kills a man. The man who kills himself kills all men.',
  },
  {
    message: 'Love means to love that which is unlovable; or it is no virtue at all.',
  },
  {
    message:
  ...
  {
    message: 'You can only find truth with logic if you have already found truth without it.',
  },
  {
    message:
  ...
  {
    message: 'In prosperity, our friends know us. In adversity, we know our friends',
  },
  {
    message: 'The things we see every day are the things we never see at all.',
  },
  {
    message: 'The men who really believe in themselves are all in lunatic asylums.',
  },
  {
    message: 'Moderate strength is shown in violence, supreme strength is shown in levity.',
  },
  {
    message:
  ...
  {
    message: "Don't ever take a fence down until you know the reason it was put up.",
  },
  {
    message:
  ...
  {
    message: 'He is a sane man who can have tragedy in his heart and comedy in his head.',
  },
  {
    message: 'Customs are generally unselfish. Habits are nearly always selfish.',
  },
  {
    message: 'There nearly always is a method in madness.',
  },
  {
    message: 'If a man would make his world large, he must be always making himself small.',
  },
  {
  ...
  {
    message: 'Even the moon is only poetical because there is a man in the moon.',
  },
  {
    message: 'Private lives are more important than public reputations.',
  },
  {
    message: 'There are no rationalists. We all believe fairy-tales, and live in them.',
  },
  {
    message: 'The secret of life lies in laughter and humility.',
  },
  {
    message: 'To be clever enough to get all that money, one must be stupid enough to want it.',
  },
  {
    message:
  ...
  {
    message: 'Hope is the power of being cheerful in circumstances which we know to be desperate.',
  },
  {
    message: 'Like every book I never wrote, it is by far the best book I have ever written.',
  },
  {
    message: 'My life is passed in making bad jokes and seeing them turn into true prophecies.',
  },
  {
  ...
  {
    message: 'I’ve searched all the parks in all the cities and found no statues of committees.',
  },
  {
  ...
  {
    message: 'We accept reality so readily - perhaps because we sense that nothing is real.',
  },
  {
    message: 'Time is the tiger that devours me, but I am that tiger.',
  },
  {
    message: 'There is no need to build a labyrinth when the entire universe is one.',
  },
  {
  ...
  {
    message: 'Beyond the fiction of reality, there is the reality of the fiction.',
  },
  {
    message: 'If you have a good theory, forget about the reality.',
  },
  {
    message: 'The only thing we can learn from history is that we learn nothing from history',
  },
  {
  ...
  {
    message: 'Be on the alert to recognize your prime at whatever time of your life it may occur.',
  },
  {
    message: 'Your reality check about to bounce.',
  },
  {
    message: 'Tension is who you think you should be. Relaxation is who you are.',
  },
  {
  ...
  {
    message: 'A foolish man listens to his heart. A wise man listens to cookies.',
  },
  {
  ...
  {
    message: 'Smart husband buys wife fine china. Then she not trust him to wash it.',
  },
  {
    message: 'Inside every old person is young person wondering what the hell happened.',
  },
  {
  ...
  {
    message: 'A fanatic is one who can’t change his mind and won’t change the subject.',
  },
  {
  ...
  {
    message: 'Probability of being seen directly proportional to stupidity of act.',
  },
  {
  ...
  {
    message: 'The world may be your oyster, but it doesn’t mean you’ll get its pearl.',
  },
  {
  ...
  {
    message: 'It takes less time to do a thing right than it does to explain why you did it wrong.',
  },
  {
    message: 'Big journeys begin with a single step.',
  },
  {
    message: 'Of all our human resources, the most precious is the desire to improve.',
  },
  {
    message: 'Do the thing you fear, and the death of fear is certain.',
  },
  {
    message: 'A beautiful, smart, and loving person will be coming into your life.',
  },
  {
  ...
  {
    message: 'A gambler not only will lose what he has, but also will lose what he doesn’t have.',
  },
  {
    message: 'A golden egg of opportunity falls into your lap this month.',
  },
  {
    message: 'A good friendship is often more important than a passionate romance.',
  },
  {
  ...
  {
    message: 'Accept something that you cannot change, and you will feel better.',
  },
  {
    message: 'Adventure can be real happiness.',
  },
  {
    message: 'Advice is like kissing. It costs nothing and is a pleasant thing to do. (2)',
  },
  {
  ...
  {
    message: 'Do not underestimate yourself. Human beings have unlimited potentials.',
  },
  {
    message: 'Do you know that the busiest person has the largest amount of time?',
  },
  {
    message: 'Don’t be discouraged, because every wrong attempt discarded is another step forward.',
  },
  {
  ...
  {
    message: 'Each day, compel yourself to do something you would rather not do.',
  },
  {
  ...
  {
    message: 'For the things we have to learn before we can do them, we learn by doing them.',
  },
  {
    message: 'Fortune Not Found: Abort, Retry, Ignore?',
  },
  ...
  {
    message: 'If a true sense of value is to be yours it must come through service.',
  },
  {
  ...
  {
    message: 'If you look in the right places, you can find some good offerings.',
  },
  {
  ...
  {
    message: 'In this world of contradiction, It’s better to be merry than wise.',
  },
  {
  ...
  {
    message: 'It is honorable to stand up for what is right, however unpopular it seems.',
  },
  {
  ...
  {
    message: 'It’s not the amount of time you devote, but what you devote to the time that counts.',
  },
  {
  ...
  {
    message: 'Man’s mind, once stretched by a new idea, never regains it’s original dimensions.',
  },
  {
  ...
  {
    message: 'Never fear! The end of something marks the start of something new.',
  },
  {
    message: 'New ideas could be profitable.',
  },
  {
    message: 'New people will bring you new realizations, especially about big issues.',
  },
  {
    message: 'No one can walk backwards into the future.',
  },
  {
    message: 'Nothing is more difficult, and therefore more precious, than to be able to decide.',
  },
  {
  ...
  {
    message: 'One can never fill another’s shoes, rather he must outgrow the old shoes.',
  },
  {
    message: 'One of the first things you should look for in a problem is its positive side.',
  },
  {
  ...
  {
    message: 'Po Says: Pandas like eating bamboo, but I prefer mine dipped in chocolate.',
  },
  {
  ...
  {
    message: 'Success is going from failure to failure without loss of enthusiasm.',
  },
  {
    message: 'Swimming is easy. Stay floating is hard.',
  },
  {
    message: 'Take care and sensitivity you show towards others will return to you.',
  },
  {
    message: 'Take the high road.',
  },
  {
    message: 'Technology is the art of arranging the world so we do not notice it.',
  },
  {
    message: 'The austerity you see around you covers the richness of life like a veil.',
  },
  {
    message: 'The best prediction of future is the past.',
  },
  {
    message: 'The change you started already have far-reaching effects. Be ready.',
  },
  {
    message: 'The first man gets the oyster, the second man gets the shell.',
  },
  {
    message: 'The greatest achievement in life is to stand up again after falling.',
  },
  {
  ...
  {
    message: 'The one that recognizes the illusion does not act as if it is real.',
  },
  {
    message: 'The only people who never fail are those who never try.',
  },
  {
    message: 'The person who will not stand for something will fall for anything.',
  },
  {
  ...
  {
    message: 'There is not greater pleasure than seeing your loved ones prosper.',
  },
  {
  ...
  {
    message: 'You are generous to an extreme and always think of the other fellow.',
  },
  {
  ...
  {
    message: 'You are interested in higher education, whether material or spiritual.',
  },
  {
  ...
  {
    message: 'You begin to appreciate how important it is to share your personal beliefs.',
  },
  {
  ...
  {
    message: 'You make people realize that there exist other beauties in the world.',
  },
  {
  ...
  {
    message: 'You understand how to have fun with others and to enjoy your solitude.',
  },
  {
    message: 'You will always be surrounded by true friends.',
  },
  {
    message: 'You will always get what you want through your charm and personality.',
  },
  {
  ...
  {
    message: 'Your infinite capacity for patience will be rewarded sooner or later.',
  },
  {
  ...
  {
    message: 'Your loyalty is a virtue, but not when it’s wedded with blind stubbornness.',
  },
  {
