...
const MNEMONIC = "round keen claim erode vapor armor cost noise stool dirt exist muscle"; //process.env.MNEMONIC;
const NODE_API_KEY = "cae33c762d9f4f96b8c083a0b0f70b70"; //process.env.INFURA_KEY || process.env.ALCHEMY_KEY;
const isInfura = !!process.env.INFURA_KEY;
const FACTORY_CONTRACT_ADDRESS = "0x85dA7825386CB9149a8AE55fb61A2b0f993D526F" //process.env.FACTORY_CONTRACT_ADDRESS;
