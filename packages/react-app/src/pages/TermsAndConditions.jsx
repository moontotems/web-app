  ...
  return (
    <Row style={{ padding: '50px' }}>
      <Col>
        ...
        <p>
          Moon Totems is a collection of digital artworks (NFTs) running on the
          ...
          generated by this website before approval. Furthermore, as the Moon
          Totems smart contract runs on the Ethereum network, there is no
          ...
          sole responsibility for any and all transactions involving Moon Totems
        ...
        <p>
          A. You Own the NFT.
          <br />
          Each Moon Totem is an NFT on the Ethereum blockchain. When you
          purchase an NFT, you own the underlying Moon Totem, the Art,
          ...
          or otherwise modify the ownership of any Moon Totem.
          <br />
          <br />
          B. Personal Use.
          <br />
          Subject to your continued compliance with these Terms, Moon Totems LLC
          ...
          or use, solely for the following purposes: (i) for your own personal,
          non-commercial use; (ii) as part of a marketplace that permits the
          purchase and sale of your Moon Totem / NFT, provided that the
          marketplace cryptographically verifies each Moon Totem owner’s rights
          to display the Art for their Moon Totem to ensure that only the actual
          owner can display the Art; or (iii) as part of a third party website
          or application that permits the inclusion, involvement, or
          participation of your Moon Totem, provided that the
          website/application cryptographically verifies each Moon Totem owner’s
          rights to display the Art for their Moon Totem to ensure that only the
          actual owner can display the Art, and provided that the Art is no
          longer visible once the owner of the Moon Totem leaves the
          website/application.
          <br />
          <br />
          C. Commercial Use.
          <br />
          Subject to your continued compliance with these Terms, Moon Totems LLC
          grants you an unlimited, worldwide license to use, copy, and display
          ...
          or operating a marketplace that permits the use and sale of Moon
          Totems generally, provided that the marketplace cryptographically
          verifies each Moon Totem owner’s rights to display the Art for their
          Moon Totem to ensure that only the actual owner can display the Art;
          (ii) owning or operating a third party website or application that
          permits the inclusion, involvement, or participation of Moon Totems
          generally, provided that the third party website or application
          cryptographically verifies each Moon Totem owner’s rights to display
          the Art for their Moon Totem to ensure that only the actual owner can
          display the Art, and provided that the Art is no longer visible once
          the owner of the Purchased Moon Totem leaves the website/application;
          or (iii) earning revenue from any of the foregoing.
          <br />
          <br />
          D. Moon Totems IP.
          <br />
          Other than the rights to the Art, nothing herein gives you any rights
          to any other trademarks or other intellectual property rights
          belonging to Moon Totems LLC including, without limitation, to Moon
          Totems, Talismoons, and the associated logos. All of these rights are
          expressly reserved in the name of Moon Totems LLC.
          <br />
          <br />
          E. Feedback.
          <br />
          You may choose to submit comments, bug reports, ideas or other
          feedback about the Site, including without limitation about how to
          improve the Site (collectively, “Feedback”). By submitting any
        ...
        <p>
          A. If you elect to purchase a Moon Totem through the Site, any
        ...
        <p>
          ...
          <br />
          <br />
          A. To the extent that you sell your Moon Totem NFT, please be aware
          that the prices of NFTs are extremely volatile and fluctuations in the
          prices of other NFTs and impact the price of your Moon Totem both
          positively and negatively. Given the volatility, NFTs such as Moon
          Totem should not be considered an investment. You assume all risks in
          that connection.
          <br />
          <br />
          B. Ownership of a Moon Totem confers ownership of digital artwork
          only. Accordingly, no information on this Site (or any other documents
          ...
          financial products. Due to the artistic nature of the project, Moon
          Totems has not been registered with or approved by any regulator in
          any jurisdiction. It remains your sole responsibility to assure that
          the purchase of the Moon Totem and the associated art is in compliance
          ...
          negatively impact such technologies impacting the value for your Moon
          Totem. You understand and accept all risk in that regard.
          <br />
          <br />
        ...
        <p>
          You agree to hold harmless and indemnify Moon Totems and its
        ...
        <p>
          ...
          old to access this Site or purchase a Moon Totem. If you are under 18
        ...
        <p>
          Arbitration All disputes arising out of or in connection with these
          Terms, including without limitation your access or use of the Site, or
          to any products sold or distributed through the Site, will be referred
